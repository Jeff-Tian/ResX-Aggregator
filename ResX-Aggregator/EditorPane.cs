...
namespace zizhujycom.ResX_Aggregator
{
    ...
    //     - An empty resx-aggregator file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.resx-aggregator. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.resx-aggregator, MyExtFile2.resx-aggregator... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.resx-aggregator|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.resx-aggregator - our empty resx-aggregator file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".resx-aggregator";
        ...
        #region Fields
        private ResX_AggregatorPackage myPackage;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidResX_AggregatorCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidResX_AggregatorCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidResX_AggregatorEditorFactory;
            return VSConstants.S_OK;
        }
