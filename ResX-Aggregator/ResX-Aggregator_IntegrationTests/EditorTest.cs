...
namespace ResX_Aggregator_IntegrationTests
{
    ...
    public class EditorTest
    {
        ...
        public void ValidateNewFileOpenedWithEditor()
        {
            UIThreadInvoker.Invoke((ThreadInvoker)delegate()
            {
                ...
                EnvDTE.Window win = dte.ItemOperations.NewFile(@"ResX Aggregator Files\ResX Aggregator", name, EnvDTE.Constants.vsViewKindPrimary);
