...
namespace zizhujycom.ResX_Aggregator
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".resx-aggregator", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "ResX-Aggregator")]
    [ProvideKeyBindingTable(GuidList.guidResX_AggregatorEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidResX_AggregatorPkgString)]
    public sealed class ResX_AggregatorPackage : Package
    {
        /// <summary>
